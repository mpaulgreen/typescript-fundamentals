...
function runTheLearningSamples() {
  function displayProductInfo(id: number, name: string) {
    console.log(`${prefix} typed paramaters`)
  ...
  console.log(`${prefix} function expressions`);
  ...
  function displayProducts(products: ProductType[]): void {
    ...
    const msg = `Sample product includes: ${productNames.join(', ')}`;
  ...
  console.log(`${prefix} Parameter with Defaults`);
